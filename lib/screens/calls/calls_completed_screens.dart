...
class CallsCompletedScreens extends StatelessWidget {
  const CallsCompletedScreens({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Chamados Finalizados', style: TextStyle(fontFamily: 'Ubuntu', fontWeight: FontWeight.w700, color: Colors.white),),
        backgroundColor: blueColor,
      ),
      body: FutureBuilder<List<dynamic>>(
        future: callsService.searchCompletedCalls(),
