...
class PausedCallListWidget extends StatelessWidget {
  const PausedCallListWidget({super.key});
          ...
          FutureBuilder<List<dynamic>>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return const Center(child: Text('Não tem chamados pausados'));
              } else {
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            const Text('Informações do Chamado Pausado', style: TextStyle(fontSize: 16, fontFamily: 'Ubuntu', fontWeight: FontWeight.w500),),
                                            ElevatedButton(
